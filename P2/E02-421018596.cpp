...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Cuadrado cafe TRONCO IZQ
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.75f, -0.73f, -2.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.25f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshColorList[6]->RenderMeshColor();

		//Cuadrado cafe TRONCO DER
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.75f, -0.73f, -2.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.25f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Triangulo verde ARBOL IZQ
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.75f, -0.205f, -2.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.4f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshColorList[4]->RenderMeshColor();

		//Triangulo verde ARBOL DER
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.75f, -0.205f, -2.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.4f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
