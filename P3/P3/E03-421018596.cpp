...
int main()
{
	...
	CrearCilindro(25, 1.0f);//índice 3 en MeshList
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		meshList[0]->RenderMesh(); //dibuja cubo, pirámide triangular y pirámide base cuadrangular 0,1,2
		//meshList[4]->RenderMeshGeometry(); //dibuja las figuras geométricas cilindro, cono, 3,4
		...
		model = glm::translate(model, glm::vec3(0.0f, 1.01f, -4.0f));
		//model = glm::translate(model, glm::vec3(0.0f, 0.75f, -1.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.0f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMesh(); //Piramide techo
		
		model = glm::mat4(1.0f);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.0f, -0.375f, -4.51f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh(); // Cubo puerta

		model = glm::mat4(1.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.2f, 0.25f, -4.51f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[0]->RenderMesh(); // Cubo ventana izquierda
		...
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[0]->RenderMesh(); // Cubo ventana derecha

		model = glm::mat4(1.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(-0.5f, 0.25f, -4.25f));
		model = glm::scale(model, glm::vec3(0.01f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[0]->RenderMesh(); // Cubo ventana lado derecho 1
		...
		model = glm::scale(model, glm::vec3(0.01f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[0]->RenderMesh(); // Cubo ventana lado derecho 2

		model = glm::mat4(1.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.51f, 0.25f, -4.25f));
		model = glm::scale(model, glm::vec3(0.01f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[0]->RenderMesh(); // Cubo ventana lado izquierdo 1

		model = glm::mat4(1.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.51f, 0.25f, -3.75f));
		model = glm::scale(model, glm::vec3(0.01f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[0]->RenderMesh(); // Cubo ventana lado izquierdo 2
		...
		model = glm::scale(model, glm::vec3(0.01f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[0]->RenderMeshGeometry(); // Cubo ventana lado derecho 1
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render(); // Cubo ventana lado derecho 2

		model = glm::mat4(1.0f);
		color = glm::vec3(0.478f, 0.255f, 0.067f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(1.5f, -0.375f, -4.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh(); // Cubo tronco izq
		...
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[0]->RenderMesh(); // Cubo tronco der
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMesh(); // Piramide arbol izq
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMesh(); // Piramide arbol der

		model = glm::mat4(1.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.0f, -0.63f, -4.0f));
